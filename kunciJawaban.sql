...
-- PERINTAH SQL UNTUK MEMASUKKAN DATA DARI FILE CSV
-- ID Pertanyaan dimulai dari 117.

-- Memasukkan data untuk tabel tes (sesuai skema baru)
-- Asumsi id=1, bidang_id=1, pelatihan_id=1
INSERT INTO tes (id, judul, deskripsi, tipe, sub_tipe, bidang_id, pelatihan_id, durasi_menit, created_at, updated_at) VALUES
(1, 'Pre-test / Post-test TP-TU', 'Tes untuk mengukur pemahaman materi TP-TU.', 'tes', 'pre-test', 1, 1, 30, NOW(), NOW());

-- Memasukkan semua data pertanyaan dengan ID dimulai dari 117
INSERT INTO pertanyaans (id, tes_id, nomor, teks_pertanyaan, gambar, tipe_jawaban, created_at, updated_at) VALUES
(117, 1, 1, 'Mesin 3R adalah mesin yang digunakan untuk melakukan proses....', NULL, 'pilihan_ganda', NOW(), NOW()),
(118, 1, 2, 'Mesin 3R dapat melakukan tiga fungsi tersebut secara', NULL, 'pilihan_ganda', NOW(), NOW()),
(119, 1, 3, 'Recovery pada mesin pendingin yaitu proses menampung', NULL, 'pilihan_ganda', NOW(), NOW()),
(120, 1, 4, 'Unit AC wajib di recovery bila dalam keadaan :', NULL, 'pilihan_ganda', NOW(), NOW()),
(121, 1, 5, 'Gambar di bawah ini merupakan symbol dari refrigeran jenis apa ?', NULL, 'pilihan_ganda', NOW(), NOW()),
(122, 1, 6, 'Gambar di bawah ini merupakan symbol dari refrigeran jenis apa ?', NULL, 'pilihan_ganda', NOW(), NOW()),
(123, 1, 7, 'Refrigeran R-290 memiliki sifat sebagai berikut, kecuali :', NULL, 'pilihan_ganda', NOW(), NOW()),
(124, 1, 8, 'Di bawah ini mana sajakah yang termasuk ke dalam jenis refrigeran HFC ?', NULL, 'pilihan_ganda', NOW(), NOW()),
(125, 1, 9, 'Kepanjangan dari GWP adalah :', NULL, 'pilihan_ganda', NOW(), NOW()),
(126, 1, 10, 'Kepanjangan dari ODP adalah :', NULL, 'pilihan_ganda', NOW(), NOW()),
(127, 1, 11, 'Gambar di bawah ini merupakan proses pembersihan part :', NULL, 'pilihan_ganda', NOW(), NOW()),
(128, 1, 12, 'Manakah yang termasuk ke dalam bagian komponen indoor AC split :', NULL, 'pilihan_ganda', NOW(), NOW()),
(129, 1, 13, 'Manakah yang termasuk ke dalam bagian komponen outdoor AC split :', NULL, 'pilihan_ganda', NOW(), NOW()),
(130, 1, 14, 'Manakah di bawah ini yang merupakan salah satu dari jenis kompresor :', NULL, 'pilihan_ganda', NOW(), NOW()),
(131, 1, 15, 'Tujuan dilakukannya perawatan AC adalah :', NULL, 'pilihan_ganda', NOW(), NOW()),
(132, 1, 16, 'Perawatan AC terbagi menjadi 2 jenis, yaitu :', NULL, 'pilihan_ganda', NOW(), NOW()),
(133, 1, 17, 'Kebutuhan alat dan bahan yang di bawah ini ada beberapa yang harus disiapkan agar proses perawtan berjalan dengan SOP, adapaun perlatan yang masih belum terakomodir adalah : ', NULL, 'pilihan_ganda', NOW(), NOW()),
(134, 1, 18, 'Gambar di bawah ini adlah langkah persiapan alat dalam langkah proses perawatan AC, Ada beberapa alat yang masih belum terakomodir pada gambar di bawah ini, adapun alat yang kurang adalah :', NULL, 'pilihan_ganda', NOW(), NOW()),
(135, 1, 19, 'Part pada indoor yang harus dibersihkan sesuai SOP no 1 s.d 6 wajib di lakukan oleh seorang calon teknisi dan teknisi, adapaun no 3 dan 4 adalah :', NULL, 'pilihan_ganda', NOW(), NOW()),
(136, 1, 20, 'Pada gambar di bawah ini Part yang harus diberishkan pada system outdoor adalah yang ter', NULL, 'pilihan_ganda', NOW(), NOW());

-- Memasukkan semua data opsi jawaban dengan pertanyaan_id yang sesuai
INSERT INTO opsi_jawabans (pertanyaan_id, teks_opsi, gambar, apakah_benar, created_at, updated_at) VALUES
-- Jawaban untuk Pertanyaan ID 117
(117, 'Recovery, recycling dan recharging pada mesin pendingin.', NULL, 1, NOW(), NOW()),
(117, 'Recycling dan recharging pada mesin pendingin', NULL, 0, NOW(), NOW()),
(117, '12 prinsip', NULL, 0, NOW(), NOW()),
(117, '10 prinsip', NULL, 0, NOW(), NOW()),
(117, '13 prinsip', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 118
(118, 'Tidak bersamaan dalam satu waktu', NULL, 0, NOW(), NOW()),
(118, 'Bergantian dalam proses', NULL, 0, NOW(), NOW()),
(118, 'Bergantian dan berjedah dalam satu proses', NULL, 0, NOW(), NOW()),
(118, 'Bersamaan dalam satu waktu', NULL, 1, NOW(), NOW()),
(118, 'Semua jawaban salah', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 119
(119, 'Recovery pada mesin pendingin yaitu proses menampung refrigerant yang ada pada sistem pendingin. Penampungan ini dilakukan karena sistem akan melakukan perawatan atau perbaikan', NULL, 1, NOW(), NOW()),
(119, 'Recovery pada refrigerasi yaitu proses menampung refrigerant yang ada pada sistem pendingin. Penampungan ini dilakukan karena sistem akan melakukan perawatan atau perbaikan', NULL, 0, NOW(), NOW()),
(119, 'Recharging pada mesin pendingin yaitu proses menampung refrigerant yang ada pada sistem pendingin. Penampungan ini dilakukan karena sistem akan melakukan perawatan atau perbaikan', NULL, 0, NOW(), NOW()),
(119, 'Pump Down pada system bagian katup SSV dan DSV pada mesin pendingin yaitu proses menampung refrigerant yang ada pada sistem pendingin. Penampungan ini dilakukan karena sistem akan melakukan perawatan atau perbaikan', NULL, 0, NOW(), NOW()),
(119, 'Semua jawaban benar', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 120
(120, 'Unit mengalami kerusakan dan memerlukan penggatian part atau pengelasan', NULL, 0, NOW(), NOW()),
(120, 'Refrigerant tidak dapat di pump down', NULL, 0, NOW(), NOW()),
(120, 'Refrigerant tidak lancer saat di pump down', NULL, 0, NOW(), NOW()),
(120, 'Unit mengalami kebocoran', NULL, 0, NOW(), NOW()),
(120, 'Semua jawaban benar', NULL, 1, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 121
(121, 'R22', NULL, 0, NOW(), NOW()),
(121, 'R32', NULL, 1, NOW(), NOW()),
(121, 'R410A', NULL, 0, NOW(), NOW()),
(121, 'R290', NULL, 0, NOW(), NOW()),
(121, 'R600', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 122
(122, 'R22', NULL, 0, NOW(), NOW()),
(122, 'R32', NULL, 0, NOW(), NOW()),
(122, 'R410A', NULL, 0, NOW(), NOW()),
(122, 'R290', NULL, 1, NOW(), NOW()),
(122, 'R600', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 123
(123, 'Tidak berbau', NULL, 0, NOW(), NOW()),
(123, 'Mudah terbakar', NULL, 0, NOW(), NOW()),
(123, 'Tidak berwarna', NULL, 0, NOW(), NOW()),
(123, 'Tidak beracun', NULL, 0, NOW(), NOW()),
(123, 'Tidak mudah terbakar', NULL, 1, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 124
(124, 'R-22', NULL, 0, NOW(), NOW()),
(124, 'R-32', NULL, 0, NOW(), NOW()),
(124, 'R-290', NULL, 0, NOW(), NOW()),
(124, 'R-410A', NULL, 0, NOW(), NOW()),
(124, 'Jawaban B dan D benar', NULL, 1, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 125
(125, 'Global Warming Potential', NULL, 1, NOW(), NOW()),
(125, 'Global Warming Protection', NULL, 0, NOW(), NOW()),
(125, 'Global Warning Potential', NULL, 0, NOW(), NOW()),
(125, 'Global Warning Protection', NULL, 0, NOW(), NOW()),
(125, 'Semua jawaban salah', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 126
(126, 'Ozone Depletion Protection', NULL, 0, NOW(), NOW()),
(126, 'Ozone Depletion Potential', NULL, 1, NOW(), NOW()),
(126, 'Ozone Danger Potential', NULL, 0, NOW(), NOW()),
(126, 'Ozone Danger Protection', NULL, 0, NOW(), NOW()),
(126, 'Semua jawaban salah', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 127
(127, 'Evaporator', NULL, 1, NOW(), NOW()),
(127, 'Kondensor', NULL, 0, NOW(), NOW()),
(127, 'Pipa kapiler', NULL, 0, NOW(), NOW()),
(127, 'Filter', NULL, 0, NOW(), NOW()),
(127, 'Outdoor', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 128
(128, 'Evaporator', NULL, 0, NOW(), NOW()),
(128, 'Pipa kapiler', NULL, 0, NOW(), NOW()),
(128, 'Motor fan', NULL, 0, NOW(), NOW()),
(128, 'PCB', NULL, 0, NOW(), NOW()),
(128, 'Semua jawaban benar', NULL, 1, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 129
(129, 'Kondensor', NULL, 0, NOW(), NOW()),
(129, 'Kompresor', NULL, 0, NOW(), NOW()),
(129, 'Kipas outdoor', NULL, 0, NOW(), NOW()),
(129, 'Pipa kapiler', NULL, 0, NOW(), NOW()),
(129, 'Semua jawaban benar', NULL, 1, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 130
(130, 'Komprensor axial', NULL, 0, NOW(), NOW()),
(130, 'Kompresor rotary', NULL, 1, NOW(), NOW()),
(130, 'Kompresor sentrifugal', NULL, 0, NOW(), NOW()),
(130, 'Kompresor hembus', NULL, 0, NOW(), NOW()),
(130, 'Jawaban a, b dan c benar', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 131
(131, 'Udara yang dihasilkan lebih bersih', NULL, 0, NOW(), NOW()),
(131, 'Kinerja AC menjadi lebih optimal', NULL, 0, NOW(), NOW()),
(131, 'Mencegah terjadinya kerusakan komponen', NULL, 0, NOW(), NOW()),
(131, 'Menghemat biaya listrik', NULL, 0, NOW(), NOW()),
(131, 'Semua jawaban benar', NULL, 1, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 132
(132, 'Skala sedang dan besar', NULL, 0, NOW(), NOW()),
(132, 'Skala kecil dan besar', NULL, 0, NOW(), NOW()),
(132, 'Skala sedang dan kecil', NULL, 0, NOW(), NOW()),
(132, 'Skala kecil,Skala Pemeliharaan bulanan', NULL, 1, NOW(), NOW()),
(132, 'Semua jawaban salah', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 133
(133, ' # Kunci Inggris 6 atau 8 Inch atau Kunci Pas 14 , # Kabel Power Supply, # Kanebo', NULL, 0, NOW(), NOW()),
(133, '# Kunci Inggris 6 atau 8 Inch atau Kunci Pas 14 , # Kabel Power Supply', NULL, 0, NOW(), NOW()),
(133, ' # Kunci Inggris 6 atau 8 Inch atau Kunci Pas 14 , # Kabel Power Supply, # Kanebo, #Sabut/Busa, #Sabun', NULL, 1, NOW(), NOW()),
(133, '#Sabut/Busa, #Sabun', NULL, 0, NOW(), NOW()),
(133, 'Semua Jawaban salah', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 134
(134, 'a.', NULL, 0, NOW(), NOW()),
(134, 'b. ', NULL, 0, NOW(), NOW()),
(134, 'c.', NULL, 0, NOW(), NOW()),
(134, 'd.', NULL, 0, NOW(), NOW()),
(134, 'e.', NULL, 1, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 135
(135, 'Cross Flow Fan dan selang pembuangan air', NULL, 1, NOW(), NOW()),
(135, 'Cross Flow Fan', NULL, 0, NOW(), NOW()),
(135, 'Selang pembuangan air', NULL, 0, NOW(), NOW()),
(135, ' Cross Flow Fan dan selang pembuangan air out door', NULL, 0, NOW(), NOW()),
(135, '  Fan dan selang pembuangan air', NULL, 0, NOW(), NOW()),
-- Jawaban untuk Pertanyaan ID 136
(136, 'a.', NULL, 1, NOW(), NOW()),
(136, 'b.', NULL, 0, NOW(), NOW()),
(136, 'c.', NULL, 0, NOW(), NOW()),
(136, 'd.', NULL, 0, NOW(), NOW()),
(136, 'e.', NULL, 0, NOW(), NOW());
