...
class PendaftaranController extends Controller
{
    ...
    {
        // This is essentially the 'store all at once' flow from the original file.
        $validatedData = $request->validate([
            // Step 1: Data Diri
            'nama' => 'required|string|max:150',
            'nik' => 'required|string|digits:16|max:20|unique:peserta,nik',
        ...
        // Simpan ke DB dalam transaction (sama seperti flow wizard)
    ...
    /**
     * Generate token assessment unique untuk satu nama + pelatihan
     */
