...
<div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow">
    <h2 class="text-lg font-bold mb-4">Tata Tertib Pre-Test</h2>
    ...
    <form action="{{ route('dashboard.pretest.start', $tes->id) }}" method="POST">
        @csrf
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded">Mulai Pre-Test</button>
        </div>
    </form>
</div>
@endsection
