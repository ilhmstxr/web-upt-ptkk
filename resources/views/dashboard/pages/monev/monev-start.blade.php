        ...
        <form id="form-monev"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                @foreach($likert as $nilai => $meta)
                    ...
                    <label class="flex items-center gap-3 p-3 border rounded-xl cursor-pointer hover:bg-indigo-50 transition">
                        <input type="radio"
                        ...
                        <span class="text-3xl leading-none">{{ $meta['emoji'] }}</span>
                        ...
                        @if($checked)
                            <span class="text-[11px] px-2 py-1 rounded-full bg-indigo-100 text-indigo-700 font-semibold">
                                Dipilih
                            </span>
                        @endif
                    </label>
