    ...
    <div class="bg-white rounded-2xl border-2 border-[#1524AF] shadow-xl p-6 sm:p-8 md:p-10">
        ...
        <div class="flex flex-col items-center text-center gap-3">
            ...
            <p class="text-[#374151] text-sm sm:text-base leading-relaxed animate-up-3">
                Terima kasih telah mendaftar di UPT PTKK.
                Simpan nomor registrasi Anda untuk keperluan login assessment dan administrasi pelatihan.
            </p>
        </div>
        ...
        <div class="mt-6 bg-[#F3F7FF] border border-[#C9D8F2] rounded-xl p-5 text-center animate-up-3">
            ...
            <div class="mt-2 flex flex-wrap items-center justify-center gap-3">
                <div id="regNumber"
                     class="font-volkhov text-[#0F1E7A] text-3xl sm:text-4xl md:text-5xl tracking-wider">
                    {{ $pendaftaran->nomor_registrasi }}
                </div>

                <button type="button" id="copyBtn"
                    class="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-[#1524AF]
                           text-[#1524AF] text-sm font-semibold
            ...
            <div id="copyNote" class="text-xs text-[#4B5563] mt-2">
                Klik untuk menyalin nomor registrasi.
            </div>
        </div>
        ...
        <div class="mt-6 bg-[#FFF7E6] border border-[#F5D48B] rounded-xl p-4 text-sm text-[#7A4B00] animate-up-4">
            ...
            Gunakan nomor registrasi di atas untuk mengakses laman assessment sesuai jadwal yang ditentukan.
        </div>

        {{-- INFORMASI EMAIL --}}
        <div class="mt-6 bg-[#EEF4FF] border border-[#C7D6FF] rounded-xl p-4 text-sm text-[#1F2A6B] animate-up-4">
            <div class="flex items-start gap-3">
                <svg class="w-5 h-5 text-[#1524AF] mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M4 4h16v12H4z"></path>
                    <path d="M22 6l-10 7L2 6"></path>
                </svg>
                <div>
                    <p class="font-semibold text-[#1524AF] mb-1">Informasi Pelatihan</p>
                    <p class="leading-relaxed">
                        Informasi lengkap terkait <strong>pelaksanaan pelatihan, penempatan asrama,
                        dan ketentuan peserta</strong> telah dikirimkan ke
                        <strong>email yang terdaftar</strong>.
                        Silakan <strong>cek email Anda</strong> dan pahami seluruh ketentuan
        ...
        <div class="mt-6 flex flex-wrap items-center gap-3 animate-up-4">
            <a href="{{ route('assessment.login') }}"
               class="inline-flex items-center gap-2 px-5 py-3 rounded-lg
                      bg-[#1524AF] text-white text-sm font-semibold
                      shadow hover:bg-[#0F1E7A] transition">
            ...
            <a href="{{ url('/') }}"
               class="inline-flex items-center gap-2 px-5 py-3 rounded-lg
                      border border-[#1524AF] text-[#1524AF] text-sm font-semibold
                      hover:bg-[#DBE7F7] transition">
                Kembali ke Beranda
            </a>
        </div>
                ...
                <a href="{{ $waUrl }}" target="_blank" rel="noopener"
                   class="inline-flex items-center gap-2 px-3 py-2 rounded-lg
                    ...
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M20.5 3.5A11 11 0 0 0 2.8 17.3L2 22l4.8-1.2A11 11 0 1 0 20.5 3.5Z"/>
                    </svg>
                    {{ $cpPhone }}
                </a>
            </div>
    ...
    if (copyBtn && regNumber) {
        copyBtn.addEventListener('click', async () => {
            try {
                ...
                if (copyNote) copyNote.textContent = 'Nomor registrasi berhasil disalin.';
            } catch {
