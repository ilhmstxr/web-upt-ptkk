  ...
  <style>
    ...
    * { font-family: 'Poppins', sans-serif; }
    ...
    @keyframes confettiFall {
      ...
      100% {transform:translateY(100vh) rotate(720deg) translateX(30px);opacity:0;}
    }
...
<body class="flex items-center justify-center p-4 sm:p-6 md:p-8">
  ...
  <div class="animate-fadeScale bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl
              p-6 sm:p-8 md:p-10 lg:p-12
              border border-white/20
              w-full max-w-md md:max-w-lg lg:max-w-xl text-center">
    <!-- Ikon sukses dengan centang besar & animasi -->
    <div class="mb-6">
      <div class="relative w-28 h-28 mx-auto flex items-center justify-center rounded-full bg-green-100 animate-pulse">
        <svg class="w-20 h-20 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path class="checkmark-draw" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 12l2 2 4-4"></path>
        </svg>
      </div>
    </div>
    ...
    <p class="fade-up text-slate-600 text-sm sm:text-base leading-relaxed mb-6" style="animation-delay:.2s">
      Terima kasih telah melakukan pendaftaran pelatihan di UPT PTKK Dinas Pendidikan Jawa Timur. Data Anda telah kami terima dan akan segera kami proses untuk verifikasi.
    </p>

    <!-- Kartu info langkah berikut -->
    <div class="fade-up bg-blue-50 border-l-4 border-blue-500 text-blue-800 p-4 rounded-r-lg text-left text-sm mb-6" style="animation-delay:.4s">
      <h4 class="font-bold mb-1 flex items-center gap-2">
        Apa langkah selanjutnya? <span class="animate-bounce">📧</span>
      </h4>
      <p>
        Mohon periksa email Anda secara berkala. Info jadwal pelatihan & tautan grup WhatsApp akan kami kirim ke email yang didaftarkan.
      </p>
    </div>

    <!-- Detail pendaftaran -->
    <div class="fade-up bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 mb-6 text-sm" style="animation-delay:.6s">
      ...
      <div class="mt-3 p-3 bg-white/70 rounded border border-blue-100 text-slate-600 text-xs">
        <strong>Pelatihan:</strong> Kegiatan Pelatihan Kompetensi Vokasi bagi Siswa SMK/SMA (MILEA) melalui Mobile Training Unit (MTU) Angkatan II Tahun 2025
      </div>
    </div>
