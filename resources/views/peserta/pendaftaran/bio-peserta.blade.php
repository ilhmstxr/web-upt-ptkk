...
<body>
    <div class="container">
        <header class="header">
            <a href="landing-page.html" class="close-btn">×</a>
            <div class="logo">
                ...
                <form id="registrationForm" action="{{ route('pendaftaran.store') }}" method="GET">
                    ...
                    <div class="form-row">
                        <div class="form-group full-width">
                            ...
                            <input type="tel" id="nomor-hp" name="nomor-hp" placeholder="Format Angka (08)"
    ...
    {{-- <script>
      ...
      document.getElementById("registrationForm").addEventListener("submit", function (e) {
        ...
        let isValid = true;
        const requiredFields = ["nama", "nik", "tempat-lahir", "tanggal-lahir", "jenis-kelamin", "agama", "alamat", "nomor-hp", "email"];
