...
<head>
    ...
    {{-- Tailwind CDN (production idealnya Vite) --}}
...
<div class="flex flex-1 relative">
    ...
    <div class="flex-1 lg:ml-64 w-full">
        ...
        {{-- Header --}}
        <header class="sticky top-0 z-20 bg-blue-100/80 border-b border-blue-200 px-4 md:px-6 py-3 flex justify-between items-center backdrop-blur">
            <div class="flex items-center gap-3">
        ...
        {{-- ===================== PAGE GRID (CONTENT + RIGHT SIDEBAR) ===================== --}}
        <main class="p-4 md:p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-7xl mx-auto fade-in">
                {{-- CONTENT --}}
