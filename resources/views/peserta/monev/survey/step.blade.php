    ...
    <div class="bg-white rounded-b-xl shadow-md overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <div class="grid grid-cols-5 gap-4 text-center">
                <div><div class="text-3xl mb-1">🤩</div><p class="text-xs font-medium">Sangat Memuaskan</p></div>
                <div><div class="text-3xl mb-1">😊</div><p class="text-xs font-medium">Memuaskan</p></div>
                <div><div class="text-3xl mb-1">😐</div><p class="text-xs font-medium">Cukup Memuaskan</p></div>
                <div><div class="text-3xl mb-1">😟</div><p class="text-xs font-medium">Tidak Memuaskan</p></div>
                <div><div class="text-3xl mb-1">😠</div><p class="text-xs font-medium">Sangat Tdk Memuaskan</p></div>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <textarea name="comments" rows="4" class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400" placeholder="Berikan saran atau masukan untuk perbaikan program pelatihan ke depan...">{{ old('comments') }}</textarea>
