      ...
      <div class="lg:col-span-4 flex flex-col justify-between">
        <div class="flex items-stretch gap-5 sm:gap-6">
          ...
          <img src="{{ asset('images/logo-provinsi-jawa-timur.png') }}"
               ...
               class="w-[110px] sm:w-[120px] h-auto object-contain shrink-0 self-start">

          {{-- Blok teks + sosmed --}}
          <div class="flex flex-col justify-between h-full py-1 w-full">
            {{-- Teks --}}
            <div class="flex flex-col">
              <p class="font-[Volkhov] font-extrabold text-[22px] sm:text-[24px] text-[#FFFFFF] leading-snug mb-3">
                UPT. PTKK
              </p>
              <div class="space-y-1">
                <p class="font-[Montserrat] text-[#FFFFFF] text-[15px] sm:text-[16px] leading-relaxed font-medium">
            ...
            <div class="flex items-center gap-3 mt-6">
              <a href="#"
                 class="w-10 h-10 flex items-center justify-center rounded-md border-2 border-[#F2C94C]
...
<div class="lg:col-span-3 flex flex-col mt-3">
  <h3 class="font-[Volkhov] font-bold text-[18px] mb-5 text-[#FFFFFF]">
    Hubungi Kami
  </h3>
  <div class="space-y-4 font-[Montserrat] font-medium">
    ...
    <div class="flex gap-3">
      ...
      <p class="text-[14px] text-[#FFFFFF] leading-relaxed">
    ...
    <div class="flex items-center gap-3">
      ...
      <p class="text-[14px] text-[#FFFFFF]">-</p>
    </div>
    ...
    <div class="flex items-center gap-3">
      ...
      <a href="mailto:uptptkk@gmail.com"
         class="text-[14px] text-[#FFFFFF] hover:text-[#F2C94C] transition">
        uptptkk@gmail.com
      </a>
    </div>
  </div>
      ...
      {{-- Kolom 3: Jam Layanan --}}
<div class="lg:col-span-2 flex flex-col mt-3">
  <h3 class="font-[Volkhov] font-bold text-[18px] mb-5 text-[#FFFFFF]">
    Jam Layanan
  </h3>
        <div class="space-y-4 font-[Montserrat] font-medium">
          ...
          <div class="flex items-center gap-3">
            ...
            <p class="text-[14px] text-[#FFFFFF]">Senin - Jumat</p>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <p class="text-[14px] text-[#FFFFFF]">08.00 - 16.00 WIB</p>
          </div>
        </div>
      </div>
...
<div class="lg:col-span-3 flex flex-col mt-3">
  <h3 class="font-[Volkhov] font-bold text-[18px] mb-5 text-[#FFFFFF]">
    Tautan Terkait
        ...
        <div class="space-y-3 font-[Montserrat] font-medium">
          <a href="#" class="flex items-center gap-2 group">
            ...
            <span class="text-[14px] text-[#FFFFFF] group-hover:text-[#F2C94C] transition">
              Tentang Kami
            </span>
          </a>
   ...
   {{-- Copyright --}}
<div class="mt-10 pt-6 border-t-2 border-[#FFFFFF]/40">
  <div class="flex items-center justify-center gap-2">
    <img src="{{ asset('images/icons/copyright.svg') }}"
         alt="Copyright Icon"
         class="w-4 h-4 object-contain opacity-90 brightness-0 invert">

    <p class="font-[Montserrat] font-medium text-[13px] text-[#FFFFFF] text-center">
