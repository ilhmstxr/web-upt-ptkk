...
<head>
    ...
    <style>
        ...
        .header { background-color: #f4f4f4; padding: 10px; text-align: center; font-weight: bold; }
        ...
        .footer { margin-top: 30px; font-size: 0.9em; border-top: 1px solid #eee; padding-top: 10px; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <table class="info-table">
            <tr><td class="label">ID Peserta</td><td>: {{ $data['id_peserta'] }}</td></tr>
            <tr><td class="label">Nama</td><td>: {{ $data['nama_peserta'] }}</td></tr>
            <tr><td class="label">Asal Lembaga</td><td>: {{ $data['asal_lembaga'] }}</td></tr>
            <tr><td class="label">Cabang Dinas Wilayah</td><td>: {{ $data['cabang_dinas'] }}</td></tr>
            <tr><td class="label">Kompetensi</td><td>: {{ $data['kompetensi'] }}</td></tr>
            <tr><td class="label">Kamar Asrama</td><td>: {{ $data['kamar_asrama'] }}</td></tr>
        </table>

        <div class="header">WAKTU DAN TEMPAT PELAKSANAAN</div>
        <table class="info-table">
            <tr><td class="label">Waktu</td><td>: {{ $data['waktu_mulai'] }} s.d {{ $data['waktu_selesai'] }}</td></tr>
            <tr><td class="label">Lokasi</td><td>: {{ $data['lokasi'] }}</td></tr>
