<table>
    <thead>
        <tr>
            <th colspan="11" style="font-weight: bold; font-size: 14px; text-align: center;">Data Peserta Pelatihan: {{ $pelatihan->nama_pelatihan ?? '-' }}</th>
        </tr>
        <tr>
           <th colspan="11" style="text-align: center;">{{ $pelatihan->angkatan ? 'Angkatan ' . $pelatihan->angkatan : '' }}</th>
        </tr>
        <tr>
