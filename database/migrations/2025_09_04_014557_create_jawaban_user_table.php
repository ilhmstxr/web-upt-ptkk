...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('jawaban_user', function (Blueprint $table) {
            ...
            $table->foreignId('pertanyaan_id')->constrained('pertanyaan')->restrictOnDelete();    // pertanyaan terkait
            $table->foreignId('percobaan_id')->constrained('percobaan')->cascadeOnDelete();     // percobaan terkait (pre/post test)
            $table->unsignedTinyInteger('nilai_jawaban')->nullable();    // untuk skala likert 1-5
